...
#include "face_vertex/proxy/triangle/adjacent_triangle.hpp"
#include "face_vertex/proxy/triangle/vertex.hpp"
#include "face_vertex/proxy/triangle/vertex_count.hpp"
